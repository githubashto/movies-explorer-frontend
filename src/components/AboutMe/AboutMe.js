...
function AboutMe() {
  return (
    <section className="aboutme section" id="about-me">
      <h2 className="section__title section__wide-lmnt">Студент</h2>
      <article className="aboutme__bio section__wide-lmnt">
        <div className="aboutme__narrative">
          ...
          <p className="aboutme__text">Я родился в Шверине (ГДР), живу в Иркутске, закончил восточный факультет БГУ.
