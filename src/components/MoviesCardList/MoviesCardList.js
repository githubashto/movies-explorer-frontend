...
function MoviesCardList(props) {
  const { saved } = props;
  const cards = (saved === true) ? [
    {id: 1, nameRU: '33 слова о дизайне', duration: 102, image: {url: './card1.png'}, isLiked: true },
    {id: 2, nameRU: 'Киноальманах «100 лет дизайна»', duration: 102, image: {url: './card2.png'}, isLiked: true },
    {id: 3, nameRU: 'В погоне за Бенкси', duration: 102, image: {url: './card3.png'}, isLiked: true },
  ]
  : [
    {id: 1, nameRU: '33 слова о дизайне', duration: 102, image: {url: './card1.png'}, isLiked: true },
    ...
    {id: 9, nameRU: 'Дженис: Маленькая девочка грустит', duration: 102, image: {url: './card9.png'}, isLiked: true },
